...
public class FeedImageServiceImpl implements FeedImageService {
  ...
  public FeedImageCursorResponse getFeedImageList(Long userId, Long cursorId) {
    ...
    List<FeedImage> feedImageList = feedImageRepository.findByFeedWriterAndNumberAndIdLessThanOrderByIdDesc(
        user, 0, cursorId, PageRequest.of(0, 20));
  ...
  public FeedImageCursorResponse getReviewImageList(Long userId, Long cursorId) {
    ...
    List<FeedImage> feedImageList = feedImageRepository.findByFeedStoreAndNumberOrderByIdDesc(user,
        0, cursorId, PageRequest.of(0, 20));
