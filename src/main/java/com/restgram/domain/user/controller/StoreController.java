...
public class StoreController {
    ...
    // 이름과 닉네임으로 가게 조회
    @GetMapping
    public ResponseEntity<ApiResponse<List<StoreInfoResponse>>> searchByNameAndNickname(@RequestParam String name) {
    ...
    // 가게 정보 변경
    @PatchMapping
    public ResponseEntity<ApiResponse<?>> updateStore(Authentication authentication, @RequestBody UpdateStoreRequest request) {
    ...
    public ResponseEntity<ApiResponse<CheckResponse>> duplicateEmail(@RequestParam("query") String query) {
