...
public class CouponServiceImpl implements CouponService {
  ...
  public List<StoreCouponResponse> getAvailableCouponList(Long storeId) {
    ...
    List<Coupon> couponList = couponRepository.findAllByStoreAndDisableAndFinishAtAfterOrderByStartAt(
        store, false, LocalDateTime.now());
  ...
  public List<StoreCouponResponse> getFinsihCouponList(Long storeId) {
    ...
    List<Coupon> couponList = couponRepository.findAllByStoreAndDisableOrFinishAtBeforeOrderByStartAt(
        store, true, LocalDateTime.now());
  ...
  public List<CustomerCouponResponse> getStoresCouponList(Long customerId, Long storeId) {
    ...
    List<Coupon> couponList = couponRepository.findAllByStoreAndDisableAndStartAtBeforeAndFinishAtAfterOrderByStartAt(
        store, true, LocalDateTime.now(), LocalDateTime.now());
