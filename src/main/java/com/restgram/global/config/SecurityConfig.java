        ...
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.PATCH, "/reservation").authenticated()
                                .requestMatchers("/reservation", "/reservation/customer").hasAuthority(UserType.CUSTOMER.getName())
                                .requestMatchers("/reservation/store").hasAuthority(UserType.STORE.getName())
                                .requestMatchers("/reservation/form").hasAuthority(UserType.STORE.getName())
                                .requestMatchers(HttpMethod.GET, "/reservation/form/**").hasAuthority(UserType.CUSTOMER.getName())
                                .requestMatchers("/reservation/**").authenticated()
                                .requestMatchers("/notification/**").authenticated()
                                .requestMatchers("/customer/calender/agree").hasAuthority(UserType.CUSTOMER.getName())
