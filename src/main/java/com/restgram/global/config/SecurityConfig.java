        ...
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers("/api/v1/store/join", "/api/v1/store/login", "/api/v1/user/reissue", "/api/v1/customer/join","/api/v1/user/logout", "/api/v1/login/oauth2/**").permitAll()
                                .requestMatchers("/api/v1/customer/info").authenticated()
                                .requestMatchers("/api/v1/address/**").authenticated()
                                .requestMatchers("/api/v1/coupon", "/api/v1/coupon/stop/**", "/api/v1/coupon/finish").hasAuthority(UserType.STORE.getName())
                                .requestMatchers("/api/v1/coupon/issue","/api/v1/coupon/**").hasAuthority(UserType.CUSTOMER.getName())
                                ...
                                .requestMatchers("/api/v1/reservation", "/api/v1/reservation/customer").hasAuthority(UserType.CUSTOMER.getName())
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/reservation/form/**").hasAuthority(UserType.CUSTOMER.getName())
                                .requestMatchers("/api/v1/reservation/**").authenticated()
                                .requestMatchers("/api/v1/notification/**").authenticated()
                                .requestMatchers("/api/v1/customer/calender/agree").hasAuthority(UserType.CUSTOMER.getName())
