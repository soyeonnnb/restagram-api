        ...
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers("/store/join", "/user/login", "/user/reissue", "/customer/join","/user/logout", "/login/oauth2/**").permitAll()
                                ...
                                .requestMatchers("/reservation/form").hasAuthority(UserType.STORE.toString())
