...
public class GlobalExceptionHandler { // extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ApiResponse.createError("ERROR-001", errors, e.getMessage()));
    }
    ...
    public ResponseEntity<Object> handleIllegalArgument(IllegalArgumentException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ApiResponse.createError("ERROR-002", errorMessage, e.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ApiResponse.createError("ERROR-003", errors, e.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleHttpMessageNotReadableException(HttpMessageNotReadableException e, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ApiResponse.createError("ERROR-004", errorMessage, e.getMessage()));
    }
