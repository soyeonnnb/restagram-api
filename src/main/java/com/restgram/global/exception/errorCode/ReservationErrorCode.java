...
public enum ReservationErrorCode implements ErrorCode {
  ...
  RESERVATION_HEAD_COUNT_EXCEED_TABLE_NUM(HttpStatus.BAD_REQUEST, "RESERVATION-006",
      "인원 수가 초과되었습니다."),
  ...
  CANNOT_FIND_RESERVATION_CANCEL(HttpStatus.BAD_REQUEST, "RESERVATION-009",
      "예약 취소 데이터를 찾을 수 없습니다."),
  ;
